    ...
    <div className="desc-side flex flex-col p-[16px] lg:w-[780px] sm:w-[343px] h-[931px] rounded-[21px]">
      <div className="flex items-center justify-between">
        <div className="flex gap-[10px] text-center text-[14px] font-bold leading-[19.1px]">
          <button className="btn1 w-[108px] h-[35px] font-bold rounded-[14px] p-[8px]">Products</button>
          <button className="btn2 w-[108px] h-[35px] font-normal rounded-[14px] p-[8px]">Articles</button>
          <button className="btn2 w-[108px] h-[35px] font-normal rounded-[14px] p-[8px]">Reviews</button>
        </div>
        <button
          className="flex items-center gap-[4px] rounded-[10px] w-[125px] h-[40px] px-5 py-2.5 text-sm font-medium text-white btn"
          href="#"
        >
          <Image
      ...
      <div className="flex items-center gap-[8px]">
        <h2 className="text-[32px] font-extrabold leading-[43.56px]">
          Products
        </h2>
